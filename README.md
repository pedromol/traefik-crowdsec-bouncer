![GitHub](https://img.shields.io/github/license/pedromol/traefik-crowdsec-bouncer)
![GitHub go.mod Go version](https://img.shields.io/github/go-mod/go-version/pedromol/traefik-crowdsec-bouncer)
[![Go Report Card](https://goreportcard.com/badge/github.com/pedromol/traefik-crowdsec-bouncer)](https://goreportcard.com/report/github.com/pedromol/traefik-crowdsec-bouncer)
[![Maintainability](https://api.codeclimate.com/v1/badges/7177dce30f0abdf8bcbf/maintainability)](https://codeclimate.com/github/pedromol/traefik-crowdsec-bouncer/maintainability)
[![ci](https://github.com/pedromol/traefik-crowdsec-bouncer/actions/workflows/main.yml/badge.svg)](https://github.com/pedromol/traefik-crowdsec-bouncer/actions/workflows/main.yml)
![GitHub tag (latest SemVer)](https://img.shields.io/github/v/tag/pedromol/traefik-crowdsec-bouncer)
![Docker Image Size (latest semver)](https://img.shields.io/docker/image-size/pedromol/traefik-crowdsec-bouncer)
...
```bash
git clone https://github.com/pedromol/traefik-crowdsec-bouncer.git && \
...
The container is available on docker as image `pedromol/traefik-crowdsec-bouncer`. Host it as you see fit, though it must have access to CrowdSec and be accessible by Traefik.   
